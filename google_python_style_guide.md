...
[Naming](#316-naming) below. Please explain the design reasons why mutable
...
must be named using all caps with underscores. See [Naming](#316-naming)
below.
...
[decorator](#217-function-and-method-decorators). Manually implementing a
...
vertically (see [line length examples](#32-line-length)), or use a hanging
...
[when a type annotation is present](#3194-default-values), *do* use spaces
...
Getters and setters should follow the [Naming](#316-naming) guidelines, such
