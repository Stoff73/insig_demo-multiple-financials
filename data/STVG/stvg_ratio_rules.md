...
| EV/Revenue | < 1.0 | 1.0-2.0 | > 2.0 | Lower is better | Yes |
...
| Ratio | PASS | MONITOR | FAIL | Notes | Enabled |
|-------|------|---------|------|-------|---------|
| Current Ratio | > 1.5x | 1.0x-1.5x | < 1.0x | Higher is better | Yes |
| Quick Ratio | > 1.0x | 0.5x-1.0x | < 0.5x | Higher is better | Yes |
...
| Interest Coverage | > 4.0x | 2.0x-4.0x | < 2.0x | Higher is better | Yes |
...
| Ratio | PASS | MONITOR | FAIL | Notes | Enabled |
|-------|------|---------|------|-------|---------|
| Cash Conversion | > 1.0 | 0.8-1.0 | < 0.8 | Higher is better | Yes |
